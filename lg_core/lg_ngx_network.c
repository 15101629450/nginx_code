...
ngx_chain_t *lg_ngx_network_buffer_to_chain(ngx_http_request_t *r, void *p_buffer, size_t size)
{
...
int lg_ngx_network_buffer_add(ngx_http_request_t *r, lg_ngx_network_t *network, void *p_buffer, size_t size)
{
...
int lg_ngx_network_str_add(ngx_http_request_t *r, lg_ngx_network_t *network, void *str)
{
    if (!str) return -1;
    int len = strlen(str);
    if (!len) return -1;
    return lg_ngx_network_buffer_add(r, network, str, len);
}

int lg_ngx_network_buffer_send(ngx_http_request_t *r, lg_ngx_network_t *network, void *p_buffer, size_t size)
{
...
int lg_ngx_network_str_send(ngx_http_request_t *r, lg_ngx_network_t *network, void *str)
{
    return lg_ngx_network_buffer_send(r, network, str, strlen(str));
}

void lg_ngx_network_buffer_post_send(ngx_http_request_t *r, lg_ngx_network_t *network, void *p_buffer, size_t size)
{
    int rc = lg_ngx_network_buffer_send(r, network, p_buffer, size);
    return ngx_http_finalize_request(r, rc); 
}

void lg_ngx_network_str_post_send(ngx_http_request_t *r, lg_ngx_network_t *network, void *str)
{
    return lg_ngx_network_buffer_post_send(r, network, str, strlen(str));
}

int lg_ngx_network_buffer_send_str(ngx_http_request_t *r, lg_ngx_network_t *network, void *p_buffer)
{
...
void lg_ngx_network_buffer_post_send_str(ngx_http_request_t *r, lg_ngx_network_t *network, void *p_buffer)
{
    if (p_buffer)
...
int lg_ngx_network_headers_add(ngx_http_request_t *r, char *key, char *value)
{
    if (!key || !value)
	return -1;
